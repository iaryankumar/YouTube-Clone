    ...
    return (
        <>
            ...
            <div className='flex items-center justify-end relative h-max overflow-x-hidden sm:pb-0 pb-18'>
                <aside className='h-[calc(100vh-65px)] w-[215px] fixed top-[65px] left-0 px-2 overflow-auto kkh md:block hidden'><Sidebar page={'history'} /></aside>
                <div className='min-h-[calc(100vh-65px)] max-h-max md:w-[calc(100%-235px)] w-full sm:py-0 py-3 flex sm:flex-row flex-col'>
                    <div className='h-max md:w-[60%] w-full px-2 pt-7 '>
                        <h1 className='text-4xl font-primary font-semibold'>Watch History</h1>
                        <div className='flex flex-col h-max w-full mt-10 gap-3 pb-5'>
                            {
                                Array(12).fill(0).map((ele, i) => {
                                    return <div key={i} className='min-h-[100px] max-h-max w-[100%] flex items-center relative'>
                    ...
                    <div className='md:w-[40%] w-full '>
                        <div className='h-[65px] fixed sm:top-[300px] bottom-0 right-0 w-[380px] flex items-center justify-center'>
                            <button className='bg-primaryFonts px-5 sm:py-2 py-3 rounded-full text-[14px] flex items-center gap-2 cursor-pointer'> <MdOutlineDeleteForever className='text-xl' /> Clear All Watch History</button>
                        </div>
                    </div>
